...
async function inputInf(){
    let ten = prompt("Hãy nhập tên: ");
    let tuoi =  prompt("Hãy nhập tuổi: ");
    let size = prompt("Hãy nhập size bánh: ");

    let temp = new Promise((resolve, reject) => {
        console.log("Bánh này của: "+ten+"("+tuoi+" tuổi"+")");
        console.log(ten+" chọn bánh size "+size);
        res();
    })
    return inputInf;
}
...
async function checkMoneyNeed(size){
    let mon
    if(inputInf.size == "S"){
